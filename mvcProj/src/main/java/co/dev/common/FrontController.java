...
//		System.out.println(contextPath); //     /mvcProj
		...
		/*
		 * key		Insert.do		List.do
		 * value	InController    LiController
		 * 
		 * mappings.get에서 키값(ex /memberList.do)이 들어가면 거기에 따른 value(LiController)가 cntr로 들어감
		 * 그것의 execute의 값들이 실행됨 
		 */

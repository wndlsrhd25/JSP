...
<body>
    ...
    <form name="orderform" id="orderform" method="post" class="orderform" action="/Page">
        ...
        <div class="bigtext right-align box blue summoney" id="sum_p_price">합계금액: <span>40,000</span>원</div>
    ...
    <div id="template" style="display: none;">
        <div class="row data">
            ...
            <div class="subdiv">
                <div class="basketcmd">
                    <a href="javascript:void(0)" class="abutton" onclick="javascript:delItem(event);">삭제</a>
                </div>
            </div>
        </div>
    </div>
